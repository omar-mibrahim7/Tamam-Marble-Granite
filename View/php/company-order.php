...
$perPage = 16;
$totalOrders = AdminOrder::countOrdersByAccountType($conn, 'company', false);
$totalPages = max(1, (int)ceil($totalOrders / $perPage));
$currentPage = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$currentPage = max(1, min($currentPage, $totalPages));
$offset = ($currentPage - 1) * $perPage;
$orders = AdminOrder::getOrdersByAccountType($conn, 'company', false, $perPage, $offset);
...
<link rel="stylesheet" href="../css/company order.css?v=<?php echo filemtime('../css/company order.css'); ?>">
...
<div class="container">
    ...
    <div class="tabs">
        ...
        <a href="company-order.php" class="active">Company Orders</a>
    ...
    <div class="table">
        ...
        <?php if (empty($orders)): ?>
        <div class="row">
            <span style="grid-column:1 / -1; justify-content:center; color:#888;">No company orders found.</span>
        </div>
        <?php endif; ?>
        ...
        <div class="row">
            ...
            <span><?php echo h($order['user_full_name']); ?></span>
...
<div class="pagination">
  <?php if ($currentPage > 1): ?>
    <a href="company-order.php?page=<?php echo $currentPage - 1; ?>"><button class="circle-btn">&lt;</button></a>
  <?php else: ?>
...
<script src="../js/company order.js?v=<?php echo filemtime('../js/company order.js'); ?>"></script>
