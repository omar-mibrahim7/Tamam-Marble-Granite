...
$perPage = 10;
$totalOrders = AdminOrder::countOrdersByAccountType($conn, 'customer', true);
$totalPages = max(1, (int)ceil($totalOrders / $perPage));
$currentPage = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$currentPage = max(1, min($currentPage, $totalPages));
$offset = ($currentPage - 1) * $perPage;
$orders = AdminOrder::getOrdersByAccountType($conn, 'customer', true, $perPage, $offset);
...
<head>
    <meta charset="UTF-8">
    <title>Completed Personal Orders</title>
...
<main class="admin-shell">
    ...
    <div class="tabs">
        ...
        <a href="completed-personal-orders.php"class="active">Completed Personal Orders</a>
        <a href="completed-company-orders.php">Completed Company Orders</a>
    </div>
    <h1 class="section-heading">Completed Personal Orders</h1>
    ...
    <div class="table-wrap">
        <table class="orders-table">
            ...
            <tbody>
                <?php if (empty($orders)): ?>
                <tr>
                    <td colspan="7">No completed personal orders found.</td>
                </tr>
                <?php endif; ?>
                ...
                <tr>
                    ...
                    <td><?php echo h($order['whatsapp'] ?: ($order['user_whatsapp'] ?: ($order['phone'] ?: $order['user_phone']))); ?></td>
...
<div class="pagination">
  <?php if ($currentPage > 1): ?>
    <a href="completed-personal-orders.php?page=<?php echo $currentPage - 1; ?>"><button class="circle-btn">&lt;</button></a>
  <?php else: ?>
